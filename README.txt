Echo Open (TM) is a collection of software modules that extend the Drupal framework to serve as a basic learning management system. It is freely distributed under GNU GPL2 for software developers to use and extend.


Installing Echo Open (TM)
...
----------------------------------------
Support for Echo Open was provided by the William and Flora Hewlett Foundation, KnowledgeWorks, and New Tech Network.
