...
<div class="BoldrBrandCrumb" style="padding-top: 0px !important; position: absolute; top: 130px;margin-left:-18px">
    <?php echo l('« back to FAQs', 'ntlp/help/faq') ?>
</div>
<h1><?php echo $node->question ?></h1>
<p>
<?php echo $content ?>
</p>
<div>Last Updated: <?php echo format_date($node->changed, 'custom', 'm/d/Y') ?></div>
