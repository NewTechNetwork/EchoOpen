...
CKEDITOR.editorConfig = function(config) {
  ...
  config.toolbar_DrupalFiltered = [
    ...
    ['Image','uploader','Flash','Table','HorizontalRule','Smiley','SpecialChar'],
    ['Maximize', 'ShowBlocks'],
    '/',
    ['Format'],
...
//   config.toolbar_DrupalBasic = [ [ 'Format', '-', 'Bold', 'Italic', '-', 'NumberedList','BulletedList', '-', 'Link', 'Unlink', 'Image' ] ];
   ...
   config.toolbar_DrupalBasic = [
                                  ...
                                  [ 'Bold', 'Italic', 'Underline', 'NumberedList','BulletedList', '-', 'JustifyLeft', 'JustifyCenter', 'JustifyRight', 'Indent', 'Outdent', '-', 'Link', 'Anchor', 'Table', 'Image', 'uploader','-', 'HorizontalRule', 'PasteFromWord', 'Print', 'Maximize'],
...
//  alert(Drupal.settings.ckeditor.module_path + '/plugins/linktonode/');
  if (Drupal.settings.ckeditor.linktocontent_node) {
