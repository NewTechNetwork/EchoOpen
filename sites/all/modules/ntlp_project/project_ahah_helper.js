 ...
 */
            Drupal.ahah.prototype.success = function (response, status) {
                ...
                //$("#edit-edit-button");
                //alert('AHAH: '+ $("#edit-edit-button").val());
//                if($("#edit-edit-button").val() == 'Edit'){
//                    $("#edit-edit-button").val("Save");
//                }else{
//                    $("#edit-edit-button").val("Edit");
//                }

                //  alert('AHAH: '+ $("#edit-edit-button", new_content).val());
